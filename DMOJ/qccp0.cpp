...
int main() {
	...
	rep (i,0,n) {
		read(a);
		str ans="";
		if (a<34.0) ans="Too cold, please try again.";
		else if (a>=34.0&&a<=35.5) ans="Take a hot bath.";
		else if (a<=38.0) ans="Rest if feeling unwell.";
		else if (a<=39.0) ans="Take some medicine.";
		else if (a<=41) ans="Take a cold bath and some medicine.";
		else if (a<=46.1) ans="Go to the hospital.";
		else if (a<=50.0) ans="Congrats, you have a new world record!";
		else ans="Too hot, please try again.";
		out(ans,'\n');
	}
